...
**URL-based (recommended for most apps):** depend on the repo root and a [SemVer tag](https://github.com/fennelouski/SwiftUI-Web-Image-Picker/tags) (e.g. `1.2.0`):

```swift
dependencies: [
    .package(name: "WebImagePicker", url: "https://github.com/fennelouski/SwiftUI-Web-Image-Picker.git", from: "1.2.0"),
]
```

A rule such as `from: "1.0.0"` still resolves any compatible **1.x** release (including `1.2.0`). After a new tag is published:
...
- **Pinned revision / exact version** — bump your rule (for example to `from: "1.2.0"`) and resolve again.
