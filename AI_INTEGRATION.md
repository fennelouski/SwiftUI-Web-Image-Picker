...
Use a **version requirement** that matches a **tag** on the default branch (e.g. `from: "1.2.0"`).
...
3. For a **remote** dependency: enter **https://github.com/fennelouski/SwiftUI-Web-Image-Picker.git** and a **version rule** (e.g. **Up to Next Major** from **1.2.0**, or **1.0.0** if you want any compatible **1.x**).
